...
Depuis plus de vingt-cinq ans, je développe des solutions ad hoc pour répondre à des besoins concrets, souvent avec des outils ou langages que je découvre au moment de leur utilisation (VBA, Python, Power Automate, entre autres). Cette pratique m’a amené à évoluer dans des environnements très variés, en privilégiant toujours l’efficacité et l’adaptation au contexte.

J’utilise également des plateformes comme SharePoint ou Google Workspace pour concevoir des outils de gestion et de circulation de l’information, en fonction des contraintes et des usages des équipes.
